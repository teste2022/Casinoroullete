$(function() {
    ...
    window.deposit = ({
        ...
        appendItem: function(item) {
            this._inventory.append(Helpers.generateItemHTML(item, item.price, ''));
        },
    ...
    deposit._confirmationButton.on('click', function() {
        ...
        socket.emit('deposit items', {
			items: deposit._selected,
			value: deposit.totalValue
		});
