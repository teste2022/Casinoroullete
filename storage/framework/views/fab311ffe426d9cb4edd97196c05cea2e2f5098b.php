<html lang="en">
	<head>
		...
		<meta name="logged" content="<?php if(Auth::check()): ?><?php echo e(1); ?><?php else: ?><?php echo e(0); ?><?php endif; ?>" />
		<meta name="id" content="<?php if(Auth::check()): ?><?php echo e(Auth::user()->id); ?><?php endif; ?>" />
		<meta name="username" content="<?php if(Auth::check()): ?><?php echo e(Auth::user()->username); ?><?php endif; ?>"/>
		<meta name="avatar" content="<?php if(Auth::check()): ?><?php echo e(Auth::user()->avatar); ?><?php endif; ?>"/>
		<meta name="token" content="<?php if(Auth::check()): ?><?php echo e(Auth::user()->token); ?><?php endif; ?>"/>
		<meta name="tradeURL" content="<?php if(Auth::check() && Auth::user()->tradeurl): ?><?php echo e(Auth::user()->tradeurl); ?><?php endif; ?>"/>
		<meta name="time" content="<?php if(Auth::check()): ?><?php echo e(Auth::user()->token_time); ?><?php endif; ?>"/>
	...
	<body>
			<div class="page-content">
				<div class="top-navigation">
					...
					<div class="account">
						<div class="avatar">
							<div class="balance" data-balance="<?php echo e(Auth::user()->wallet); ?>">
								<i class="far fa-money-bill-alt" aria-hidden="true"></i>
								<span class="value"><?php echo e(Auth::user()->wallet); ?></span>
							</div>
							<div class="user-navbar">
								<div class="accountname"><?php echo e(Auth::user()->username); ?></div>
							</div>
				...
				<div class="main-content">
					...
					<div class="sidebar-content">
						...
						<div class="my-profile" id="profile" style="display: none;">
							<div class="user-info">
								<img class="avatar" src="<?php echo e(Auth::user()->avatar); ?>">
								<div class="nick">Welcome, <span><?php echo e(Auth::user()->username); ?></span></div>
							</div>
							<div class="box">
								<label for="trade-url">Trade Link<a target="_blank" href="https://trade.opskins.com/settings"> Find it Here </a></label>
								<div class="group-input">
									<input type="text" id="trade-url" placeholder="Enter Your trade URL" value="<?php if(Auth::check() && Auth::user()->tradeurl): ?><?php echo e(Auth::user()->tradeurl); ?><?php endif; ?>"> <button id="trade-url-send"><i class="fa fa-floppy-o" aria-hidden="true"></i></button>
								</div>
							</div>
							<div class="box">
								<label for="id">Your</label>
								<div class="group-input">
									<input type="text" id="id" readonly value="<?php echo e(Auth::user()->id); ?>"> <button id="id-copy"><i class="fa fa-clone" aria-hidden="true"></i></button>
								</div>
							</div>
							<div class="stats">
								<div class="stats-won">
									<div class="label">won</div>
									<div class="value"><?php echo e(Auth::user()->total_won); ?></div>
								</div>
								<div class="stats-lost">
									<div class="label">lost</div>
									<div class="value"><?php echo e(Auth::user()->total_lose); ?></div>
								</div>
								<div class="stats-profit">
									<div class="label">profit</div>
									<div class="value"><?php echo e((Auth::user()->total_won)-(Auth::user()->total_lose)); ?></div>
								</div>
							</div>
							<div class="table">
							...
							<div class="top">
								...
								<div class="top-box">
									<div class="box">
										...
										<div class="group-input">
											<?php if(empty(Auth::user()->inviter)): ?>
											<input type="text" id="get-coins" placeholder="Enter Your Code...">
											<?php else: ?>
											<input type="text" id="get-coins" placeholder="Already used" disabled> <?php endif; ?> <button id="get-coins-button">✔</button>
										</div>
									</div>
									<div class="box">
										<label>Put <a class="lime">VGOPunk.com</a> in your name for 30 coins daily!</label>
										<div class="group-input">
											<?php if(Auth::user()->last_free_use + 86400 < time()): ?>
												<button data-api="free-coins" class="free-coins full-size lime">Check Your Nickname</button>
											<?php else: ?>
												<button data-api="free-coins" class="free-coins full-size reload-time" data-timeleft="<?php echo e((Auth::user()->last_free_use + 86400) - time()); ?>">You have to wait</button>
											<?php endif; ?>
										</div>
									</div>
									<div class="box">
									...
									<div class="box">
										...
										<div class="group-input">
											<input type="text" id="set-code" placeholder="Enter a code..." value="<?php echo e(Auth::user()->code); ?>"> <button id="set-code-button">✔</button>
										</div>
									</div>
								</div>
								<div class="top-box">
									<div class="box2">
										...
										<div class="value"><?php echo e($reffered); ?></div>
									</div>
									<div class="box2 profit">
										<div class="label">Total Earned</div>
										<div class="value"><?php if($profit < 0): ?> <span style="font-size: 20;">Press <font color="#ffcc01"><b>&nbsp;"GET"&nbsp;</b></font> to see your profit!</span> <?php else: ?> <?php echo e($profit); ?> <?php endif; ?> </div>
									</div>
			...
			<?php if((Auth::check()) && (Auth::user()->rank == 'siteAdmin')): ?><script src="/js/adminchat.js"></script>
			<?php elseif((Auth::check()) && (Auth::user()->rank == 'siteMod')): ?><script src="/js/modchat.js"></script>
			<?php elseif((Auth::check()) && (Auth::user()->rank == 'root')): ?><script src="/js/rootchat.js"></script>
			<?php else: ?><script src="/js/userchat.js"></script>
			<?php endif; ?>
